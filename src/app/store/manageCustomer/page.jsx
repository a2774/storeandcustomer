...
import { FaUsers, FaSearch, FaPlus, FaSpinner, FaArrowLeft, FaEye, FaEdit, FaTrash } from 'react-icons/fa';
          ...
          <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 mb-6'>
            <div className='flex flex-col sm:flex-row gap-3 w-full lg:w-auto'>
              ...
              <div className='flex gap-2'>
                ...
                <button onClick={handleAddCustomer} className='bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg flex items-center gap-2 transition-colors'>
                  <FaPlus />
                  Add Customer
                </button>
              </div>
                    ...
                    <table className='w-full border-collapse'>
                      ...
                      <tbody>
                        {currentCustomers.length > 0 ? (
                          ...
                          <tr>
                            <td colSpan={6} className='p-8 text-center text-gray-500 border-t'>
